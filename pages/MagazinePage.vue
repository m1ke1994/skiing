...
const courses = ref([
{
    ...
    detailed: `Этот курс подойдет тем, кто уже делает первые шаги на лыжах, умеет 
    поворачивать в плуге и кататься по «зеленым» трассам, но чувствует неуверенность.
  ...
  },
  {
    ...
    detailed: `Для тех, кто уже уверенно выполняет связанные повороты, использует все 
    виды подъемников и стремится совершенствовать свою технику катания, предлагаются 
    занятия по улучшению навыков. Вы научитесь оставлять четкий след от кантов лыж, 
  ...
  },
  {
    ...
    detailed: `Для тех, кто уже уверенно катает карвинг и справляется с крутыми склонами, 
  ...
  },
  {
    ...
    image: "/img/individual2.jpg", // Замените на актуальный путь к изображению
    price: 60000,
    ...
    Подходит для тех, кто хочет быстро улучшить свои навыки катания. Занятия проводятся 
  ...
  },
  {
    ...
    image: "/img/individual10.jpg", // Замените на актуальный путь к изображению
    price: 26000,
  ...
  },
  {
    ...
    image: "/img/group15.jpg", // Замените на актуальный путь к изображению
    price: 17000,
  ...
  },
  {
    ...
    image: "/img/group30.jpg", // Замените на актуальный путь к изображению
    price: 30000,
    ...
    рассчитана на глубокое освоение техники катания и отработку всех ключевых элементов. 
...
const addToCart = (course) => {
  ...
  console.log('Добавлено в корзину:', course);
};
...
<template>
   <header>
      <HeaderApp :isFuncBasket="isFuncBasket" :isBasket="isBasket"></HeaderApp>
    </header>
    <main class="bg-[#034184]">
        <ul>
        <li v-if="isBasket"><BasketApp :isFuncBasket="isFuncBasket"></BasketApp></li>
        <li v-if="isButtonOrder" class="overlay"></li>
